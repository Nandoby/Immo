 ...
 */
final class Version20221124152357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ad (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, type_id INT NOT NULL, location_id INT NOT NULL, transaction_id INT NOT NULL, price NUMERIC(20, 2) NOT NULL, rooms INT NOT NULL, description LONGTEXT DEFAULT NULL, living_space INT NOT NULL, year_of_construction INT NOT NULL, building_condition VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_77E0ED58A76ED395 (user_id), INDEX IDX_77E0ED58C54C8C93 (type_id), INDEX IDX_77E0ED5864D218E (location_id), INDEX IDX_77E0ED582FC0CB0F (transaction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ad ADD CONSTRAINT FK_77E0ED582FC0CB0F FOREIGN KEY (transaction_id) REFERENCES transaction (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ad DROP FOREIGN KEY FK_77E0ED582FC0CB0F');
